...
struct UA_ServerConfig {
     ...
     * @param sessionContext An optional pointer to user-defined data for the specific
     * data source
     * @param nodeid Id of the node in question
     * @param nodeidContext An optional pointer to user-defined data, associated
     *        with the node in the nodestore. Note that, if the node has already been
     * removed, this value contains a NULL pointer.
    ...
    void (*monitoredItemRegisterCallback)(UA_Server *server, const UA_NodeId *sessionId,
                                          void *sessionContext, const UA_NodeId *nodeId,
                                          void *nodeContext, UA_UInt32 attibuteId,
                                          UA_Boolean removed);
#endif
