 ...
 * @param registeredServersSize size of returned array, i.e., number of found/registered
 * servers
...
UA_Client_Service_read(UA_Client *client, const UA_ReadRequest request) {
    ...
    __UA_Client_Service(client, &request, &UA_TYPES[UA_TYPES_READREQUEST], &response,
...
UA_Client_Service_write(UA_Client *client, const UA_WriteRequest request) {
    ...
    __UA_Client_Service(client, &request, &UA_TYPES[UA_TYPES_WRITEREQUEST], &response,
...
UA_Client_Service_call(UA_Client *client, const UA_CallRequest request) {
    ...
    __UA_Client_Service(client, &request, &UA_TYPES[UA_TYPES_CALLREQUEST], &response,
...
UA_Client_Service_addNodes(UA_Client *client, const UA_AddNodesRequest request) {
    ...
    __UA_Client_Service(client, &request, &UA_TYPES[UA_TYPES_ADDNODESREQUEST], &response,
...
UA_Client_Service_browse(UA_Client *client, const UA_BrowseRequest request) {
    ...
    __UA_Client_Service(client, &request, &UA_TYPES[UA_TYPES_BROWSEREQUEST], &response,
...
UA_Client_Service_translateBrowsePathsToNodeIds(
    UA_Client *client, const UA_TranslateBrowsePathsToNodeIdsRequest request) {
    UA_TranslateBrowsePathsToNodeIdsResponse response;
    __UA_Client_Service(
        client, &request, &UA_TYPES[UA_TYPES_TRANSLATEBROWSEPATHSTONODEIDSREQUEST],
