...
typedef void (*UA_Client_DeleteSubscriptionCallback)(UA_Client *client, UA_UInt32 subId,
                                                     void *subContext);
...
typedef void (*UA_Client_DeleteMonitoredItemCallback)(UA_Client *client, UA_UInt32 subId,
...
typedef void (*UA_Client_EventNotificationCallback)(UA_Client *client, UA_UInt32 subId,
                                                    void *subContext, UA_UInt32 monId,
...
UA_Client_MonitoredItems_modify(UA_Client *client,
    ...
    __UA_Client_Service(client, &request, &UA_TYPES[UA_TYPES_MODIFYMONITOREDITEMSREQUEST],
