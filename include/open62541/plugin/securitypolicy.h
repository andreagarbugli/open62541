...
typedef struct {
    ...
    UA_StatusCode (*verify)(const UA_SecurityPolicy *securityPolicy, void *channelContext,
    ...
    UA_StatusCode (*sign)(const UA_SecurityPolicy *securityPolicy, void *channelContext,
     ...
     * @param securityPolicy the securityPolicy the function is invoked on.
     * @param channelContext the context to retrieve data from.
     * @return the length of the signing key in bytes. Returns 0 if no length can be
     * found.
     */
...
typedef struct {
     ...
     *                   asymmetricModule. */
    UA_StatusCode (*makeCertificateThumbprint)(
        const UA_SecurityPolicy *securityPolicy, const UA_ByteString *certificate,
        UA_ByteString *thumbprint) UA_FUNC_ATTR_WARN_UNUSED_RESULT;
    ...
    UA_StatusCode (*compareCertificateThumbprint)(
        const UA_SecurityPolicy *securityPolicy,
        const UA_ByteString *certificateThumbprint) UA_FUNC_ATTR_WARN_UNUSED_RESULT;
...
typedef struct {
    ...
    UA_StatusCode (*generateKey)(const UA_SecurityPolicy *securityPolicy,
                                 ...
                                 UA_ByteString *out) UA_FUNC_ATTR_WARN_UNUSED_RESULT;
...
typedef struct {
    ...
    UA_StatusCode (*newContext)(const UA_SecurityPolicy *securityPolicy,
                                ...
                                void **channelContext) UA_FUNC_ATTR_WARN_UNUSED_RESULT;
    ...
    UA_StatusCode (*setLocalSymEncryptingKey)(
        void *channelContext, const UA_ByteString *key) UA_FUNC_ATTR_WARN_UNUSED_RESULT;
    ...
    UA_StatusCode (*setRemoteSymEncryptingKey)(
        void *channelContext, const UA_ByteString *key) UA_FUNC_ATTR_WARN_UNUSED_RESULT;
    ...
    UA_StatusCode (*setRemoteSymSigningKey)(
        void *channelContext, const UA_ByteString *key) UA_FUNC_ATTR_WARN_UNUSED_RESULT;
