...
UA_Client_readNodeIdAttribute(UA_Client *client, const UA_NodeId nodeId,
                              UA_NodeId *outNodeId) {
    return __UA_Client_readAttribute(client, &nodeId, UA_ATTRIBUTEID_NODEID, outNodeId,
...
UA_Client_readValueAttribute(UA_Client *client, const UA_NodeId nodeId,
                             UA_Variant *outValue) {
    return __UA_Client_readAttribute(client, &nodeId, UA_ATTRIBUTEID_VALUE, outValue,
...
static UA_INLINE UA_StatusCode
UA_Client_readMinimumSamplingIntervalAttribute(UA_Client *client, const UA_NodeId nodeId,
...
typedef UA_Boolean (*UA_HistoricalIteratorCallback)(UA_Client *client,
...
UA_Client_writeNodeIdAttribute(UA_Client *client, const UA_NodeId nodeId,
    ...
    return __UA_Client_writeAttribute(client, &nodeId, UA_ATTRIBUTEID_NODEID, newNodeId,
                                      &UA_TYPES[UA_TYPES_NODEID]);
}
...
UA_Client_writeUserWriteMaskAttribute(UA_Client *client, const UA_NodeId nodeId,
    ...
    return __UA_Client_writeAttribute(client, &nodeId, UA_ATTRIBUTEID_USERWRITEMASK,
...
UA_Client_writeContainsNoLoopsAttribute(UA_Client *client, const UA_NodeId nodeId,
    ...
    return __UA_Client_writeAttribute(client, &nodeId, UA_ATTRIBUTEID_CONTAINSNOLOOPS,
...
UA_Client_writeEventNotifierAttribute(UA_Client *client, const UA_NodeId nodeId,
    ...
    return __UA_Client_writeAttribute(client, &nodeId, UA_ATTRIBUTEID_EVENTNOTIFIER,
...
UA_Client_writeValueAttribute(UA_Client *client, const UA_NodeId nodeId,
    ...
    return __UA_Client_writeAttribute(client, &nodeId, UA_ATTRIBUTEID_VALUE, newValue,
                                      &UA_TYPES[UA_TYPES_VARIANT]);
}
...
UA_Client_writeUserAccessLevelAttribute(UA_Client *client, const UA_NodeId nodeId,
    ...
    return __UA_Client_writeAttribute(client, &nodeId, UA_ATTRIBUTEID_USERACCESSLEVEL,
                                      newUserAccessLevel, &UA_TYPES[UA_TYPES_BYTE]);
}

static UA_INLINE UA_StatusCode
UA_Client_writeMinimumSamplingIntervalAttribute(UA_Client *client, const UA_NodeId nodeId,
...
UA_Client_writeUserExecutableAttribute(UA_Client *client, const UA_NodeId nodeId,
    ...
    return __UA_Client_writeAttribute(client, &nodeId, UA_ATTRIBUTEID_USEREXECUTABLE,
